...
public class UseFileStream {
    ...
    private void testFile() throws IOException {
        ...
        //  프로젝트와 무관하게 파일을 찾을때
        File readMe = new File("C:\\Users\\user\\SSAFY\\workspace\\JAVA\\java_0728\\java_ssafy_8th_l\\src\\com\\ssafy\\live5\\io\\node\\readme.txt");
        
        //  프로젝트 내부에서 파일을 찾을때(소스 경로가 아닌 컴파일 후 나오는 경로)
        ...
        System.out.println("readMe.txt가 존재하는 지? " + readMe.exists());
    ...
    public long fileMove(int bufferSize) {
        ...
        File src = new File("C:\\Users\\user\\Workspace\\tool-workspace\\zulu8.33.0.1-ca-jdk8.0.192-win_x64.zip");
        File target = new File("C:\\Users\\user\\SSAFY\\workspace\\eclipse.zip");
